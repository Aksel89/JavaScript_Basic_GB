...
function showCategory(category) {
    ...
    let markupProductsDiv = '';
    productsCategory.forEach(function (product) {
        markupProductsDiv += getProductMarkup(product);
    });
    productEl.insertAdjacentHTML('afterbegin', markupProductsDiv);
}
...
function getProductMarkup(product) {
    return `<div class = "product">
                ...
                <a href = "https://mysite.shop/products/${product.id}">Подробнее</a>
            </div>`
}
